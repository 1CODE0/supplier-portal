...
import { Paper, Typography, Button, List, ListItem, ListItemText, Box, CircularProgress, Card } from '@mui/material'
      ...
      <Card>
        ...
        >
          ...
          <Button
            ...
            onClick={() => router.push(ePathVariables.NEW_SUPPLIERS)}
          >
            New Supplier
          </Button>
        </div>
              ...
              return (
                <ListItem key={supplier.id} divider>
                  <ListItemText
                    ...
                    secondary={new Date(Number(supplier.updatedAt) * 1000).toLocaleString()}
                  />
                  <EditDeleteActions
